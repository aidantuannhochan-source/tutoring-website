...
const I18N = {
  en: {
    ...
    'subj2.name': 'Science',
    'subj2.desc': 'Physics, chemistry, biology — concepts explained with real intuition, not just formulas',
    'subj3.name': 'French',
  ...
  fr: {
    ...
    'subj2.name': 'Sciences',
    'subj2.desc': 'Physique, chimie, biologie — concepts expliqués avec vraie intuition, pas juste des formules',
    'subj3.name': 'Français',
